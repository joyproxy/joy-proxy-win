...
> 当前阶段：**详细设计已完成**（见 [docs/DETAILED_DESIGN.md](docs/DETAILED_DESIGN.md)），进入 M1 编码。
...
- [DESIGN.md](DESIGN.md) — 概要设计（架构、WFP 方案、路线图）
- [docs/DETAILED_DESIGN.md](docs/DETAILED_DESIGN.md) — 详细设计（IPC、WFP API、Relay FFI、里程碑）
...
| UI | C# WinUI 3 |
| WFP Helper | C++ |
| TCP Relay | Rust (`joyproxy_relay.dll`) |
